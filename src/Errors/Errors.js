...
export default (message, arr) =>(
   ...
   <h1 className="light">
    ...
    <div className="Main Description">
        {arr.map(i=> (<p className={'errors text-danger'} key={uuid()} style={{margin:'20px 0'}}> {i} </p>))}
        <p className="errors light">If you feel this is an issue mail If you feel this is an error register an <a className="accent" href="./issues">Issue</a> or mail <a className="accent" href="mailto:kosikenspears@gmail.com">KRC</a></p>
    </div>
